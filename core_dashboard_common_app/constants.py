...
DASHBOARD_PROFILE_EDIT_TEMPLATE = 'core_dashboard_common_app/my_profile_edit.html'
...
# Tables
DASHBOARD_RECORDS_TEMPLATE_TABLE = 'core_dashboard_common_app/list/my_dashboard_my_records_table.html'
...
DASHBOARD_FORMS_TEMPLATE_TABLE = 'core_dashboard_common_app/list/my_dashboard_my_forms_table.html'
DASHBOARD_TEMPLATES_TEMPLATE_TABLE = 'core_dashboard_common_app/list/my_dashboard_my_templates_table.html'
DASHBOARD_TYPES_TEMPLATE_TABLE = 'core_dashboard_common_app/list/my_dashboard_my_types_table.html'
DASHBOARD_FILES_TEMPLATE_TABLE='core_dashboard_common_app/list/my_dashboard_my_files_table.html'
DASHBOARD_WORKSPACES_TEMPLATE_TABLE='core_dashboard_common_app/list/my_dashboard_my_workspaces_table.html'

# Assets
MODALS_COMMON_DELETE = "core_dashboard_common_app/list/modals/delete_document.html"
MODALS_COMMON_CHANGE_OWNER = "core_dashboard_common_app/list/modals/change_owner.html"
...
JS_COMMON = [{
            ...
            {
                "path": 'core_dashboard_common_app/user/js/init.js',
                "is_raw": False
            }]

JS_INIT_USER = 'core_dashboard_common_app/user/js/init_user.js'
JS_USER_TABLE = 'core_dashboard_common_app/user/js/user_table.js'
JS_USER_SELECTED_ELEMENT = 'core_dashboard_common_app/user/js/get_selected_document.js'
JS_COMMON_FUNCTION_DELETE = 'core_dashboard_common_app/user/js/list/modals/delete_document.js'
JS_COMMON_FUNCTION_CHANGE_OWNER = 'core_dashboard_common_app/user/js/list/modals/change_owner.js'
...
JS_ADMIN_SELETED_ELEMENT = 'core_dashboard_common_app/admin/js/get_selected_document_admin.js'
